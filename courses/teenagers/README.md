# AI Introduction for Teenagers

**Learn to use AI well—and remain able to think, choose and act for yourself.**

A complete first-edition course designed for ages 13–17. This is a design range, not proof of service eligibility or tested reading level. Adult guidance is available through the [facilitator guide](FACILITATOR-GUIDE.md).
...
Read the [sources and limitations](SOURCES.md), [reuse licence](LICENSE.md) and [developer guide](DEVELOPER-GUIDE.md). This is AI-assisted educational writing. Learning effectiveness and age suitability have not been established through learner testing. No professional qualification, service endorsement or guaranteed outcome is offered.
