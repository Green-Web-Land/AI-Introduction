...
[Home](README.md) · [Licence](LICENSE.md) · [Parent/teacher guide](PARENT-TEACHER-GUIDE.md)
...
Optional AI demonstrations belong under the parent/teacher guide's service-rule checks and adult control. Supervision does not override age restrictions. Do not infer that a content licence grants software or trademark rights, or guarantees suitability for children.

Developer checks: resolve local links, retain notices, test keyboard and screen-reader navigation in the actual renderer, and verify that content works without external AI access. Rendering and application tests remain the integrating developer's responsibility; the Markdown author checks are not application acceptance.
